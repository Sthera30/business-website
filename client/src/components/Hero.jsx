    ...
    return (
        <div className='hero-container'>
            ...
            <div className='hero-content'>
                ...
                <motion.p initial={{ opacity: 0, y: -100 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: .8, delay: .8 }}>Welcome to Sthe Digital Agency - your trusted partner for professional web design and SEO services in Gqeberha, Uitenhage, and across South Africa. Our team of experienced developers is dedicated to building modern, results-driven websites that help small businesses grow their online presence and reach more customers locally and beyond.</motion.p>
