        ...
        <div className='burner-content-container'>
            ...
            <div className='burder-content'>
                ...
                <div className='right-content'>
                    ...
                    <motion.img initial={{opacity: 0, y:-50}} whileInView={{opacity: 1, y:0}} viewport={{once: true}} transition={{duration: .8, delay: .8}} src={img1} alt="Sthe digital agency services logo" />
